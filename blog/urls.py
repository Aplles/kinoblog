...
from blog.views.post import PostListView, PostCreateView, PostDetailView, PostDeleteView, PostFilterView, PostRedactionView
from blog.views.comment import CommentCreateView
from blog.views.user import UserLoginView, UserRegisterView, logout_user


urlpatterns = [    
    path('posts/<int:id>/redaction/', PostRedactionView.as_view(), name="redaction_post"),
